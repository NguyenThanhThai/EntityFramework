...
namespace Microsoft.EntityFrameworkCore.Specification.Tests
{
        ...
        where TFixture : ComplexNavigationsQueryFixtureBase<TTestStore>, new()
    {
        ...
        public virtual void Where_navigation_property_to_collection2()
            => AssertQuery<Level3>(
                l3s => l3s.Where(l3 => l3.OneToOne_Required_FK_Inverse.OneToMany_Optional.Count > 0),
                l3s => l3s.Where(l3 => MaybeScalar<int>(
                    l3.OneToOne_Required_FK_Inverse.OneToMany_Optional,
                    () => l3.OneToOne_Required_FK_Inverse.OneToMany_Optional.Count) > 0),
                e => e.Id,
                (e, a) => Assert.Equal(e.Id, a.Id));
